...
export class HeroGrid {
    ...
    render() {
        ...
        // Extreme Performance: Render ทั้งหมดทันทีแบบ Synchronous เพื่อความเร็วสูงสุด
        const html = filtered.map(hero => {
            ...
            return `
                <div class="hero-card ${statusClass} ${globalClass}" 
                     ...
                     onclick="if(!this.classList.contains('disabled')) draftApp.onHeroClick(${hero.id})">
